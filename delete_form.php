...
?>
          ...
          <button onclick="location.href='delete.php?num=<?=$num?>&page=<?=$page?>'">삭제</button>
				</li>
<?php
   	   $number--;
   }
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='delete_form.php?page=$new_page'>◀ 이전</a> </li>";
	}
	else
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='delete_form.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)
   	{
		$new_page = $page+1;
		echo "<li> <a href='delete_form.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else
		echo "<li>&nbsp;</li>";
?>
